...
d19_e1 = """px{a<2006:qkq,m>2090:A,rfg}
pv{a>1716:R,A}
lnx{m>1548:A,A}
...
test(19, 1, d19_e1, "19114")
test(19, 2, d19_e1, "167409079868000")

d20_e1 = """broadcaster -> a, b, c
%a -> b
%b -> c
%c -> v
&v -> a"""

d20_e2 = """broadcaster -> a
%a -> v, c
&v -> b
%b -> c
&c -> o"""

test(20, 1, d20_e1, "32000000")
test(20, 1, d20_e2, "11687500")
...
test(23, 1, d23_e1, "94")
test(23, 2, d23_e1, "154")

d24_e1 = """19, 13, 30 @ -2,  1, -2
18, 19, 22 @ -1, -1, -2
20, 25, 34 @ -2, -2, -4
12, 31, 28 @ -1, -2, -1
20, 19, 15 @  1, -5, -3"""
